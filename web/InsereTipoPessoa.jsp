<%@page contentType="text/html" pageEncoding="UTF-8" import="br.com.Modelo.pessoa"%>
<%
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h2>Inserir Nova Função</h2></div>
                        <table class="table">
                            <form name="formITP" action="ITP" method="POST">            
                                <thead>
                                    <tr>
                                        <th> Campos </th>
                                        <th> Valores </th>
                                ...
                                <tbody>
                                    ...
                                    <tr><td colspan="2"><input class="btn btn-default btn-success" type="submit" value="ENVIAR" name="ENVIAR" /></td></tr>
                                </tbody>
                        </table>
                        </form>
                    </div>
