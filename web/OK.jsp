            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h2>Operação realizada com sucesso!</h2></div>
                        <table class="table">
                            <tbody>
                                <tr><td><a href="sistema.jsp"><input class="btn btn-default btn-success" type="submit" value="VOLTAR À PÁGINA INICIAL" name="ENVIAR" /></a></td>
                            </tbody>
                        </table>
                    </div>
                </div>
